...
/**
 * Created by Magdalena on 2/12/2017.
 */

public class getWeeklyDataFromSQLite extends AsyncTask<Void, Void, Void> {

    Context context;
   // String daySelectionFilter;

    public getWeeklyDataFromSQLite(Context c) {
        context = c;
    ...
    protected Void doInBackground(Void... params) {
      ...
      //  String selection = NutrientDBEntry.COLUMN_DATE + " = Monday";

      /*  String[] selectionArgs = new String[7];

        //ova treba da go prezememe od spinnerot- i da dodavame ime na den
        selectionArgs[0] = "Monday";
        selectionArgs[1] = "Tuesday";
        selectionArgs[2] = "Wednesday";
        selectionArgs[3] = "Thursday";
        selectionArgs[4] = "Friday";
        selectionArgs[5] = "Saturday";
        selectionArgs[6] = "Sunday"; */

        //selectionArgs[0] = "09.02.2018";

        Cursor cursor = db.query(NutrientDBEntry.TABLE_NAME, projection, null, null, null, null, null);
        ...
        intent.setAction("GetWeeklyValues");
        intent.putExtra("Nutrients3",torki);
